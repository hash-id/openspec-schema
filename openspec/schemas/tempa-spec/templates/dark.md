<!-- Variant: planning-only | +implementation -->
<!-- Created: <timestamp> -->
...
<!-- Same shape as Proposal. -->
-

## Design

<!-- Same shape as Proposal. Empty (or section omitted) if design.md was not created this change. -->
-
...
<!-- +implementation only. One entry per resolved finding per review pass (1-3 passes), same shape and HIGH-first ordering. Note the verified-behavior check performed before each steel-man argument. -->
-
